...
def generate_answer_with_llm2(query, model_name="google/flan-t5-large", similarity_threshold=0.85): # Text2Text generation
...
if query:
    if query.lower() == 'quit':
        ...
        answer = generate_answer_with_llm2(query)
